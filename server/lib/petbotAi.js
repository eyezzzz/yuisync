  ...
  return [
    {
      ...
      content: [
        ...
        'Campos permitidos: customer_name, intent, pet_name, species, breed, size, age_category, product_kind, brand, package_preference, package_kg, quantity, service_type, service_notes, service_date, service_time_preference, service_preferred_time, symptom, payment_method, fulfillment_type, delivery_address, neighborhood, city, reference, wants_human, wants_discount, wants_image, confirmation, negation, confidence, raw_summary.',
